...
fit       =  ebpm::ebpm_gamma_mixture_single_scale(x = sim$x, s = sim$s, scale = "estimate", theta = "max", g_init = NULL, fix_g = F, m = 2, control = NULL)

scale = list(shape = fit$fitted_g$shape, scale = 1/fit$fitted_g$scale)
fit_scale =  ebpm::ebpm_gamma_mixture(x = sim$x, s = sim$s, scale = scale, g_init = NULL, fix_g = F, m = 2, control = NULL)

fit_init =  ebpm::ebpm_gamma_mixture(x = sim$x, s = sim$s, scale = "estimate", g_init = fit$fitted_g, fix_g = F, m = 2, control = NULL)

fit_fix =  ebpm::ebpm_gamma_mixture(x = sim$x, s = sim$s, scale = "estimate", g_init = fit$fitted_g, fix_g = T, m = 2, control = NULL)
...
# test = readRDS("../ebpmf_demo/data/ebpm_fail.Rds")
# x = test$x
# s = test$s
# 
# #browser()
# fit = ebpm_gamma_mixture(x, s)
