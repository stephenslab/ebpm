...
rm(list = ls())
devtools::load_all(".")
context("test_ebpm_two_gamma_fast4")
library(ebpm)
set.seed(123)
...
fit_start_truth = ebpm::ebpm_two_gamma_fast4(sim$x, sim$s, g_init = g_true)

fit <- ebpm::ebpm_two_gamma_fast4(sim$x, sim$s)


fit_fixg <- ebpm::ebpm_two_gamma_fast4(sim$x, sim$s, g_init = fit$fitted_g, fix_g = T)
